...
export const MOVES_DB = {
  ...
  flare_blitz:  {name:'Flare Blitz',   type:'fire',    cat:'physical', power:120, acc:100, pp:15,
                  effect:'burn', effectChance:10, recoil:true, recoilFraction:0.333},
  ...
  fire_fang:    {name:'Fire Fang',     type:'fire',    cat:'physical', power:65,  acc:95,  pp:15,
                  effect:'burn', effectChance:10, flinchChance:10},
  fire_spin:    {name:'Fire Spin',     type:'fire',    cat:'special',  power:35,  acc:85,  pp:15,
                  effect:'trap', trapTurns:5, trapDmgFraction:8},
  ...
  dragon_rush:  {name:'Dragon Rush',   type:'dragon',  cat:'physical', power:100, acc:75,  pp:10,
                  flinchChance:20},
